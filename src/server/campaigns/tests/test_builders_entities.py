"""Test suite for builder entity creation and end-to-end workflows.

Tests complete entity building workflows from path parsing through
database persistence. Validates:
- Complete builder workflows for each entity type
- Entity creation with all fields populated
...
These tests ensure builders can create valid, fully-populated entities
from file paths and metadata.
"""
...
class TestMeasurementBuilder:
    ...
    @patch("server.campaigns.builders.logger")
