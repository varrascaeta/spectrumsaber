# flake8: noqa
"""
Django settings for spectrumsaber project.
...
LOCAL_APPS = [
    ...
    "server.campaigns.apps.CampaignsConfig",
    "server.places.apps.PlacesConfig",
]
...
# Airflow settings
AIRFLOW_USER = os.getenv("_AIRFLOW_WWW_USER_USERNAME")
AIRFLOW_PASSWORD = os.getenv("_AIRFLOW_WWW_USER_PASSWORD")
