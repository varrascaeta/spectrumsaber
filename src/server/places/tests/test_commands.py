...
# Project imports
from server.campaigns.models import Campaign, Coverage
from server.places.management.commands.load_places import Command
...
class TestLoadPlacesCommand:
    ...
    @patch("server.places.management.commands.load_places.pd.read_excel")
    @patch("server.places.management.commands.load_places.logger")
