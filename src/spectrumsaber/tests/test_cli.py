...
class TestCLIClient:
    ...
    def cli_client(self):
        ...
        from spectrumsaber.cli import CLIClient
    ...
    def mock_console(self):
        ...
        with patch("spectrumsaber.cli.Console") as mock_console_class:
...
class TestMainFunction:
    ...
    @patch("spectrumsaber.cli.sys.argv", ["client.py", "--help"])
    def test_main_with_help_flag(self):
        """Test main shows help when --help is passed"""
        from spectrumsaber.cli import main
    ...
    @patch("spectrumsaber.cli.sys.argv", ["client.py", "--interactive"])
    @patch("spectrumsaber.cli.RichInteractiveClient")
    ...
    @patch("spectrumsaber.cli.CLIClient")
    @patch("spectrumsaber.cli.Console")
    ...
    def test_main_query_without_credentials_fails(self, mock_console):
        ...
        with (
            ...
            patch("spectrumsaber.cli.CLIClient") as mock_cli_client,
            patch("spectrumsaber.cli.sys.exit") as mock_exit,
        ):
            mock_client = Mock()
            mock_client.saber_client.is_authenticated.return_value = False
            mock_cli_client.return_value = mock_client
    ...
    @patch("spectrumsaber.cli.CLIClient")
    @patch("spectrumsaber.cli.Console")
    def test_main_with_already_authenticated(
        self, mock_console, mock_cli_client
    ):
    ...
    def test_main_with_no_action(self, mock_console, mock_cli_client):
        ...
        with patch(
            "spectrumsaber.cli._build_arg_parser"
    ...
    @patch("spectrumsaber.cli.CLIClient")
    @patch("spectrumsaber.cli.Console")
    def test_main_with_query_file(
        self, mock_console, mock_cli_client, tmp_path
    ):
    ...
    @patch("spectrumsaber.cli.sys.argv", ["client.py", "--text2gql"])
    @patch("spectrumsaber.cli._run_text2gql_repl")
