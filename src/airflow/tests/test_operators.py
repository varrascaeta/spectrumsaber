...
class TestSetupDjango:
    ...
    def test_setup_django_execute_sets_environment(self):
        ...
        with patch("django.setup"):
            ...
            assert os.environ.get("DJANGO_SETTINGS_MODULE") == "service.settings"
...
class TestScanFTPDirectory:
    ...
    def test_scan_ftp_directory_execute_with_directory(self, mock_ftp_client):
        ...
        mock_ftp_client.get_dir_data.return_value = [
            {"path": "/test/path/file1.txt", "is_dir": False, "name": "file1.txt"},
            {"path": "/test/path/dir1", "is_dir": True, "name": "dir1"},
        ]

        with patch("src.airflow.operators.FTPClient") as mock_ftp_class:
    ...
    def test_scan_ftp_directory_execute_logs_path(self, mock_ftp_client, caplog):
